...
public class PracticeMeetMethods {

    Arnold_Hardware r = new Arnold_Hardware();
     ...
     */
    public PracticeMeetMethods(LinearOpMode _opMode) {
        opMode = _opMode;
    ...
    public boolean targets_acquired(double righttarget, double lefttarget, double distance) {
        ...
        opMode.telemetry.addData("Right targ", righttarget);
        opMode.telemetry.addData("Right enc", rightEnc);
        opMode.telemetry.addData("Left targ", lefttarget);
        opMode.telemetry.addData("Left enc", leftEnc);
    ...
    public void update_motors() {
        rightEnc = -r.rightBackMotor.getCurrentPosition();
        leftEnc = -r.leftBackMotor.getCurrentPosition();
