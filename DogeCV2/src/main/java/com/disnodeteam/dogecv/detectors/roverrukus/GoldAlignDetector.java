...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public Mat process(Mat input) {
        ...
        for(MatOfPoint cont : contoursYellow){
            ...
            if(score < bestDiffrence && (rect.y + rect.height) > blindYValue){
        ...
        Imgproc.line(displayMat, new Point(0, blindYValue), new Point(630,blindYValue), new Scalar(100,255,100));
        ...
        if(bestRect != null) {
            ...
            // ****CORE WROTE THIS****
            yPos = bestRect.y + bestRect.height;
            goldYPos = yPos;

            // Draw center point
            Imgproc.circle(displayMat, new Point(xPos, yPos), 5, new Scalar(0,255,0),2);
